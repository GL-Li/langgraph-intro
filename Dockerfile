...
ADD . /deps/data-analyst-agent-langgraph-intro
# -- End of local package . --

# -- Installing all local dependencies --
RUN PYTHONDONTWRITEBYTECODE=1 pip install --no-cache-dir -c /api/constraints.txt -e /deps/*
# -- End of local dependencies install --
ENV LANGSERVE_GRAPHS='{"scout": "/deps/data-analyst-agent-langgraph-intro/scout/graph.py:graph"}'
...
WORKDIR /deps/data-analyst-agent-langgraph-intro